...
<!--                                
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" value="" name="school" autocomplete="on" />
                                        <!--<span class="help-inline">Please correct the error</span>-->
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" value="" name="city" id="city" autocomplete="off" />
                                        <!--<span class="help-inline">Please correct the error</span>-->
                                    </div>
                                </div>
                                <div class="control-group">
...
<!--                                <div class="control-group">
                                ...
                                <div class="control-group">
                                    <label  class="control-label input-lable pull-left">First Name<span class="required">*</span></label>
                                    <div class="controls">
                                        <input type="text" value="" name="p_firstName" autocomplete="off" />
                                        <!--<span class="help-inline">Please correct the error</span>-->
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label  class="control-label input-lable pull-left">Last Name</label>
                                    <div class="controls">
                                        <input type="text" value="" name="p_lastName" autocomplete="off" />
                                        <!--<span class="help-inline">Please correct the error</span>-->
                                    </div>
                                </div>
                                <div class="control-group">
                                ...
                                <div class="control-group">
                                    <label  class="control-label input-lable pull-left">Phone</label>
                                    <div class="controls">
                                        <input type="text" value="" name="p_phone" autocomplete="off"/>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <div class="controls">
