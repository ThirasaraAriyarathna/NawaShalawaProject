                ...
                <div class="vd-page-content">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-xs-12 col-sm-6">
                            <div class="inline-container">
                                <form class="navbar-form navbar-left col-md-12" id="class_index_search_form" role="search" onsubmit="return false;">
                    ...
                    <div class="row">
                        <div class="col-md-12" id="class_list_container">
                            ...
                            <div class=" col-sm-6 col-md-4">
                                <div class="inline-container">
                                    <a class="class-item class_data_index"  href="<?php echo base_url().'classes/profile/'.$class['ClassId']; ?>"  id="<?php echo $class['ClassId']; ?>">
                    ...
                    <div class=" clearfix">
                        <div class="col-md-12" id="load_more_show">
                            <input type="button" batch_id="" class_name="" offset="" searchtype="1" id="load_more_classes" class="hidden col-md-12 btn btn-default btn-flat" value="Load More" />
                        </div>
                    </div>
                </div>
            </div>
