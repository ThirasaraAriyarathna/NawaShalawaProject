                    ...
                    <div class="row">
                        <div  class="col-md-12  ">
                                <div class="inline-container">
                                    <div  class="col-md-8  ">
                                        <form role="form" id="class-add-form" method="post" action="<?php echo base_url().'classes/edit/'.$class_detail['ClassId']; ?>" >
                                              

                                                <div class="form-group"  >
                                                    <label class="input-lable">Class Name</label>
                                                    <input type="text" class="form-control input-flat" value="<?php echo $class_detail['Name']; ?>"  id="class_name" autocomplete="off"  name="class_name"  >

                                                </div>
                                                <div class="form-group">
                                                    <label class="input-lable">Description</label>
                                                    <textarea rows="3"  class="form-control input-flat"  name="description"  ><?php echo $class_detail['Description']; ?></textarea>
                                                       ...
                                                       <option value="0">Select Teacher</option>
                                                        ...
                                                        if (isset($teachers) && count($teachers) > 0) {
                                                            foreach ($teachers as $teacher) {
                                                                    if($teacher['TeacherId']==$class_detail['TeacherId']){ ?>
                                                                        <option value="<?php echo $teacher['TeacherId']; ?>" selected=""><?php echo $teacher['FirstName'] . ' ' . $teacher['LastName']; ?></option>
                                                              <?php      }
                                                                    else{ ?>
                                                        ...
                                                        <select name="batches" class=" form-control input-flat" id="batches"  >
                                                            ...
                                                            if (isset($batches) && count($batches) > 0) {
                                                                foreach ($batches as $batch) {
                                                                    if($batch['BatchId']==$class_detail['BatchId']){ ?>
                                                                        
                                                            <option  selected="" value="<?php echo $batch['BatchId']; ?>" ><?php echo $batch['Name'] . '-' . $batch['Year']; ?></option>
                                                                <?php    }else{?>
                                                        ...
                                                        <select name="subjects" class=" form-control input-flat" id="subjects"  >
                                                            ...
                                                            if (isset($subjects) && count($subjects) > 0) {
                                                                foreach ($subjects as $subject) {
                                                                     if($subject['SubjectId']==$class_detail['SubjectId']){ ?>
                                                                         
                                                            <option selected="" value="<?php echo $subject['SubjectId']; ?>" ><?php echo $subject['Name']; ?></option>
                                                                 <?php    }
                                                                 else{
                                                                       ?>
