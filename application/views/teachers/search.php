            ...
            <div id="content_wrapper">
                <div id="content"> 
                    ...
                    <div id="sub-menu" class="row pull-right">
                        <button class="btn btn-primary" id="btn_viewAllteachers" type="button">View All</button>
                    ...
                    <div id="ele-student_search_form" class="well student_search_form">
                        ...
                        <form id="searchTeacherForm" onsubmit="return false;"  class="form-search">
                            <div class="control-group span4">
                                ...
                                <button class="btn" type="button" id="btnteacherSearch">Search</button>
...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-footer">
            <button  teacherId="" type="button" class="btn btn-danger " id="btn-delete-teacher-yes">Yes</button>
